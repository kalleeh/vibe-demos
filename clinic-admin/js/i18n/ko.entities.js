...
export default {
  ...
  "org.stepNote": "기관명·요양기관기호·사업자등록번호·종별·대표자는 비급여 보고·연말정산 자료·자보 정산표의 머리글에 쓰입니다. 지금 건너뛰어도 됩니다 — 상단 기관 칩이나 조직 › 기관 프로필에서 언제든 입력할 수 있어요. 데모라면 「샘플 데이터로 둘러보기」가 한솔한방병원으로 채워줍니다.",
  ...
  "users.rosterNote": "로그인은 조직 › 직원 명부의 한 행에 연결됩니다 — 직종·면허는 명부에서, PIN은 여기서.", "users.openRoster": "명부 열기 →",
