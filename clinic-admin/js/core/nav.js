...
const TABS = [
  ...
  tab("tab-guarantee", "patients", 1, "nav.guarantee", "G"),
  tab("tab-docs",      "patients", 2, "nav.docs",      "D"),
  tab("tab-consent",   "patients", 3, "nav.consent",   "✓"),
  tab("tab-claims",    "claims",   0, "nav.claims",    "▤"),
  tab("tab-kcd",       "claims",   1, "nav.kcd",       "K"),
  tab("tab-jabo",      "claims",   2, "nav.jabo",      "J"),
  tab("tab-nhis",      "claims",   3, "nav.nhis",      "N"),
  tab("tab-appeal",    "claims",   4, "nav.appeal",    "A"),
